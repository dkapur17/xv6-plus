  ...
  16:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  25:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    int pid = fork();
  2c:	e8 ca 02 00 00       	call   2fb <fork>
    if(pid == 0)
  31:	85 c0                	test   %eax,%eax
  33:	75 22                	jne    57 <main+0x57>
    {
        exec(argv[1], argv);
  35:	50                   	push   %eax
  36:	50                   	push   %eax
  ...
  57:	50                   	push   %eax
  58:	50                   	push   %eax
  59:	8d 45 f4             	lea    -0xc(%ebp),%eax
  5c:	50                   	push   %eax
  5d:	8d 45 f0             	lea    -0x10(%ebp),%eax
  60:	50                   	push   %eax
  61:	e8 ad 02 00 00       	call   313 <waitx>
  ...
  6c:	ff 75 f4             	pushl  -0xc(%ebp)
  6f:	ff 73 04             	pushl  0x4(%ebx)
  72:	68 fc 07 00 00       	push   $0x7fc
  77:	6a 01                	push   $0x1
 ...
 1c9:	31 f6                	xor    %esi,%esi
{
 ...
 1e8:	50                   	push   %eax
 1e9:	6a 00                	push   $0x0
 1eb:	e8 33 01 00 00       	call   323 <read>
    if(cc < 1)
...
printf(int fd, const char *fmt, ...)
{
 ...
 4b9:	e8 6d fe ff ff       	call   32b <write>
 ...
 519:	e8 0d fe ff ff       	call   32b <write>
        putc(fd, c);
      } else {
 ...
 52d:	e8 f9 fd ff ff       	call   32b <write>
  for(i = 0; fmt[i]; i++){
 ...
 5a1:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5a4:	e8 82 fd ff ff       	call   32b <write>
        ap++;
 ...
 5f4:	eb 1a                	jmp    610 <printf+0x1a0>
          s = "(null)";
 5f6:	bb 5f 08 00 00       	mov    $0x85f,%ebx
        while(*s != 0){
 ...
 61b:	57                   	push   %edi
 61c:	53                   	push   %ebx
 61d:	e8 09 fd ff ff       	call   32b <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 73b:	e8 53 fc ff ff       	call   393 <sbrk>
  if(p == (char*)-1)
