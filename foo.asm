...
int main(int argc, char *argv[]) {
  ...
  2b:	e8 8b 03 00 00       	call   3bb <getpid>
  30:	56                   	push   %esi
  for ( k = 0; k < n; k++ ) 
  31:	83 c7 01             	add    $0x1,%edi
      printf(1, "Parent %d creating child %d\n",getpid(), pid);
  34:	50                   	push   %eax
  35:	68 2e 08 00 00       	push   $0x82e
  3a:	6a 01                	push   $0x1
  3c:	e8 5f 04 00 00       	call   4a0 <printf>
      wait();
  41:	e8 f5 02 00 00       	call   33b <wait>
  ...
  56:	79 d1                	jns    29 <main+0x29>
      printf(1, "%d failed in fork!\n", getpid()); 
  58:	e8 5e 03 00 00       	call   3bb <getpid>
  ...
  82:	e8 39 02 00 00       	call   2c0 <atoi>
  if (n < 0 || n > 20)
  ...
  9b:	6a 05                	push   $0x5
  9d:	e8 29 03 00 00       	call   3cb <sleep>
      printf(1,"Child %d created\n",getpid());
  a2:	e8 14 03 00 00       	call   3bb <getpid>
  a7:	83 c4 0c             	add    $0xc,%esp
  aa:	50                   	push   %eax
  ab:	68 1c 08 00 00       	push   $0x81c
  b0:	6a 01                	push   $0x1
  b2:	e8 e9 03 00 00       	call   4a0 <printf>
  b7:	83 c4 10             	add    $0x10,%esp
      for(z = 0; z < 4000000000; z++)
  ba:	eb fe                	jmp    ba <main+0xba>
  for ( k = 0; k < n; k++ ) 
  bc:	85 c0                	test   %eax,%eax
  be:	0f 85 61 ff ff ff    	jne    25 <main+0x25>
  c4:	eb b1                	jmp    77 <main+0x77>
  c6:	66 90                	xchg   %ax,%ax
  c8:	66 90                	xchg   %ax,%ax
  ca:	66 90                	xchg   %ax,%ax
  cc:	66 90                	xchg   %ax,%ax
 ...
 1f9:	31 f6                	xor    %esi,%esi
{
 ...
 218:	50                   	push   %eax
 219:	6a 00                	push   $0x0
 21b:	e8 33 01 00 00       	call   353 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 281:	e8 f5 00 00 00       	call   37b <open>
  if(fd < 0)
 ...
 295:	50                   	push   %eax
 296:	e8 f8 00 00 00       	call   393 <fstat>
  close(fd);
 29b:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 29e:	89 c6                	mov    %eax,%esi
  close(fd);
 2a0:	e8 be 00 00 00       	call   363 <close>
  return r;
 ...
 3fc:	89 d1                	mov    %edx,%ecx
{
 ...
 46e:	56                   	push   %esi
 46f:	57                   	push   %edi
 470:	e8 e6 fe ff ff       	call   35b <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 4e9:	e8 6d fe ff ff       	call   35b <write>
 ...
 549:	e8 0d fe ff ff       	call   35b <write>
        putc(fd, c);
      } else {
 ...
 55d:	e8 f9 fd ff ff       	call   35b <write>
  for(i = 0; fmt[i]; i++){
 ...
 5d1:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5d4:	e8 82 fd ff ff       	call   35b <write>
        ap++;
 ...
 624:	eb 1a                	jmp    640 <printf+0x1a0>
          s = "(null)";
 626:	bb 4b 08 00 00       	mov    $0x84b,%ebx
        while(*s != 0){
 ...
 64b:	57                   	push   %edi
 64c:	53                   	push   %ebx
 64d:	e8 09 fd ff ff       	call   35b <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 675:	a1 0c 0b 00 00       	mov    0xb0c,%eax
{
 ...
 696:	73 10                	jae    6a8 <free+0x38>
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	a3 0c 0b 00 00       	mov    %eax,0xb0c
}
 6c7:	5e                   	pop    %esi
 6c8:	5f                   	pop    %edi
 6c9:	5d                   	pop    %ebp
 ...
 6e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ea:	a3 0c 0b 00 00       	mov    %eax,0xb0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 70d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 710:	8b 3d 0c 0b 00 00    	mov    0xb0c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 759:	8b 3d 0c 0b 00 00    	mov    0xb0c,%edi
 ...
 76b:	e8 53 fc ff ff       	call   3c3 <sbrk>
  if(p == (char*)-1)
 ...
 782:	e8 e9 fe ff ff       	call   670 <free>
  return freep;
 787:	a1 0c 0b 00 00       	mov    0xb0c,%eax
 ...
 7b4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7b7:	a3 0c 0b 00 00       	mov    %eax,0xb0c
}
 ...
 7ce:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 0c 0b 00 00 10 	movl   $0xb10,0xb0c
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	bf 10 0b 00 00       	mov    $0xb10,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 10 0b 00 00 10 	movl   $0xb10,0xb10
 7e6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7eb:	c7 05 14 0b 00 00 00 	movl   $0x0,0xb14
 7f2:	00 00 00 
    if(p->s.size >= nunits){
