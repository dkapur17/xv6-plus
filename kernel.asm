...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 03 7b 10 80 	movl   $0x80107b03,(%esp)
...
80102020:	68 8a 7c 10 80       	push   $0x80107c8a
...
801037d1:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->priority = 60;
801037d8:	c7 83 8c 00 00 00 3c 	movl   $0x3c,0x8c(%ebx)
801037df:	00 00 00 
  p->pid = nextpid++;
...
801037ed:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
801037f3:	e8 08 11 00 00       	call   80104900 <release>
...
80103819:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010381c:	c7 40 14 27 5c 10 80 	movl   $0x80105c27,0x14(%eax)
  p->context = (struct context*)sp;
...
8010382b:	e8 20 11 00 00       	call   80104950 <memset>
...
80103836:	c7 40 10 a0 38 10 80 	movl   $0x801038a0,0x10(%eax)
  p->ctime = ticks;
8010383d:	a1 a0 59 11 80       	mov    0x801159a0,%eax
  p->etime = 0;
...
8010384f:	89 d8                	mov    %ebx,%eax
  p->rtime = 0;
80103851:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
80103858:	00 00 00 
  p->iotime = 0;
8010385b:	c7 83 88 00 00 00 00 	movl   $0x0,0x88(%ebx)
80103862:	00 00 00 
}
...
801038fa:	68 00 7a 10 80       	push   $0x80107a00
...
801039e7:	e8 44 38 00 00       	call   80107230 <setupkvm>
...
80103a05:	e8 f6 34 00 00       	call   80106f00 <inituvm>
...
80103a73:	68 30 7a 10 80       	push   $0x80107a30
80103a78:	50                   	push   %eax
80103a79:	e8 92 10 00 00       	call   80104b10 <safestrcpy>
  p->cwd = namei("/");
80103a7e:	c7 04 24 39 7a 10 80 	movl   $0x80107a39,(%esp)
...
80103ab7:	68 17 7a 10 80       	push   $0x80107a17
...
80103aff:	e8 ec 32 00 00       	call   80106df0 <switchuvm>
  return 0;
...
80103b1a:	e8 31 35 00 00       	call   80107050 <allocuvm>
...
80103b3a:	e8 41 36 00 00       	call   80107180 <deallocuvm>
...
80103b8c:	e8 6f 37 00 00       	call   80107300 <copyuvm>
...
80103ca6:	e8 95 0b 00 00       	call   80104840 <acquire>
...
80103cc0:	e8 2b 31 00 00       	call   80106df0 <switchuvm>
...
80103ccb:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103cd2:	e8 9c 0e 00 00       	call   80104b73 <swtch>
      switchkvm();
80103cd7:	e8 f4 30 00 00       	call   80106dd0 <switchkvm>
      c->proc = 0;
...
80103d5b:	75 41                	jne    80103d9e <sched+0x8e>
  intena = mycpu()->intena;
80103d5d:	e8 ae fb ff ff       	call   80103910 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103d62:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103d65:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103d6b:	e8 a0 fb ff ff       	call   80103910 <mycpu>
80103d70:	83 ec 08             	sub    $0x8,%esp
80103d73:	ff 70 04             	pushl  0x4(%eax)
80103d76:	53                   	push   %ebx
80103d77:	e8 f7 0d 00 00       	call   80104b73 <swtch>
  mycpu()->intena = intena;
80103d7c:	e8 8f fb ff ff       	call   80103910 <mycpu>
}
...
80103dda:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103ddd:	e8 5e 09 00 00       	call   80104740 <pushcli>
  c = mycpu();
80103de2:	e8 29 fb ff ff       	call   80103910 <mycpu>
  p = c->proc;
80103de7:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ded:	e8 9e 09 00 00       	call   80104790 <popcli>
  if(curproc == initproc)
80103df2:	8d 73 28             	lea    0x28(%ebx),%esi
80103df5:	8d 7b 68             	lea    0x68(%ebx),%edi
80103df8:	39 1d b8 a5 10 80    	cmp    %ebx,0x8010a5b8
80103dfe:	0f 84 08 01 00 00    	je     80103f0c <exit+0x13c>
...
80103e2f:	ff 73 68             	pushl  0x68(%ebx)
...
80103e4a:	e8 f1 09 00 00       	call   80104840 <acquire>
...
80103e60:	05 90 00 00 00       	add    $0x90,%eax
80103e65:	3d 54 51 11 80       	cmp    $0x80115154,%eax
...
80103e77:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e7e:	05 90 00 00 00       	add    $0x90,%eax
80103e83:	3d 54 51 11 80       	cmp    $0x80115154,%eax
...
80103ea0:	81 c2 90 00 00 00    	add    $0x90,%edx
80103ea6:	81 fa 54 51 11 80    	cmp    $0x80115154,%edx
...
80103ec7:	90                   	nop
80103ec8:	05 90 00 00 00       	add    $0x90,%eax
80103ecd:	3d 54 51 11 80       	cmp    $0x80115154,%eax
...
80103ee6:	eb e0                	jmp    80103ec8 <exit+0xf8>
  curproc->etime = ticks;
80103ee8:	a1 a0 59 11 80       	mov    0x801159a0,%eax
  curproc->state = ZOMBIE;
80103eed:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  curproc->etime = ticks;
80103ef4:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
  sched();
80103efa:	e8 11 fe ff ff       	call   80103d10 <sched>
  panic("zombie exit");
80103eff:	83 ec 0c             	sub    $0xc,%esp
80103f02:	68 88 7a 10 80       	push   $0x80107a88
80103f07:	e8 84 c4 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103f0c:	83 ec 0c             	sub    $0xc,%esp
80103f0f:	68 7b 7a 10 80       	push   $0x80107a7b
...
80103f30:	e8 0b 09 00 00       	call   80104840 <acquire>
  pushcli();
80103f35:	e8 06 08 00 00       	call   80104740 <pushcli>
  c = mycpu();
80103f3a:	e8 d1 f9 ff ff       	call   80103910 <mycpu>
  p = c->proc;
80103f3f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f45:	e8 46 08 00 00       	call   80104790 <popcli>
  myproc()->state = RUNNABLE;
80103f4a:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103f51:	e8 ba fd ff ff       	call   80103d10 <sched>
  release(&ptable.lock);
80103f56:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103f5d:	e8 9e 09 00 00       	call   80104900 <release>
}
...
80103f80:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103f83:	e8 b8 07 00 00       	call   80104740 <pushcli>
  c = mycpu();
80103f88:	e8 83 f9 ff ff       	call   80103910 <mycpu>
  p = c->proc;
80103f8d:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f93:	e8 f8 07 00 00       	call   80104790 <popcli>
  if(p == 0)
...
80103fef:	5d                   	pop    %ebp
    acquire(lk);
80103ff0:	e9 4b 08 00 00       	jmp    80104840 <acquire>
...
80103ffb:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80104002:	e8 09 fd ff ff       	call   80103d10 <sched>
  p->chan = 0;
...
80104019:	68 9a 7a 10 80       	push   $0x80107a9a
8010401e:	e8 6d c3 ff ff       	call   80100390 <panic>
    panic("sleep");
80104023:	83 ec 0c             	sub    $0xc,%esp
80104026:	68 94 7a 10 80       	push   $0x80107a94
...
80104038:	53                   	push   %ebx
  pushcli();
80104039:	e8 02 07 00 00       	call   80104740 <pushcli>
  c = mycpu();
8010403e:	e8 cd f8 ff ff       	call   80103910 <mycpu>
  p = c->proc;
80104043:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104049:	e8 42 07 00 00       	call   80104790 <popcli>
  acquire(&ptable.lock);
8010404e:	83 ec 0c             	sub    $0xc,%esp
80104051:	68 20 2d 11 80       	push   $0x80112d20
80104056:	e8 e5 07 00 00       	call   80104840 <acquire>
...
80104070:	81 c3 90 00 00 00    	add    $0x90,%ebx
80104076:	81 fb 54 51 11 80    	cmp    $0x80115154,%ebx
...
80104087:	74 37                	je     801040c0 <wait+0x90>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104089:	81 c3 90 00 00 00    	add    $0x90,%ebx
      havekids = 1;
8010408f:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104094:	81 fb 54 51 11 80    	cmp    $0x80115154,%ebx
...
801040d2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801040d9:	e8 d2 30 00 00       	call   801071b0 <freevm>
        release(&ptable.lock);
...
801040fe:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80104105:	e8 f6 07 00 00       	call   80104900 <release>
        return pid;
...
80104123:	e8 d8 07 00 00       	call   80104900 <release>
      return -1;
...
80104143:	e8 f8 06 00 00       	call   80104840 <acquire>
...
80104158:	05 90 00 00 00       	add    $0x90,%eax
8010415d:	3d 54 51 11 80       	cmp    $0x80115154,%eax
...
8010416f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104176:	05 90 00 00 00       	add    $0x90,%eax
8010417b:	3d 54 51 11 80       	cmp    $0x80115154,%eax
...
8010418c:	c9                   	leave  
  release(&ptable.lock);
8010418d:	e9 6e 07 00 00       	jmp    80104900 <release>
...
801041b3:	e8 88 06 00 00       	call   80104840 <acquire>
...
801041c8:	05 90 00 00 00       	add    $0x90,%eax
801041cd:	3d 54 51 11 80       	cmp    $0x80115154,%eax
...
801041f5:	e8 06 07 00 00       	call   80104900 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104210:	e8 eb 06 00 00       	call   80104900 <release>
}
...
80104253:	68 03 7b 10 80       	push   $0x80107b03
80104258:	e8 53 c4 ff ff       	call   801006b0 <cprintf>
8010425d:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104260:	81 c3 90 00 00 00    	add    $0x90,%ebx
80104266:	81 fb c0 51 11 80    	cmp    $0x801151c0,%ebx
...
80104277:	74 e7                	je     80104260 <procdump+0x30>
      state = "???";
80104279:	ba ab 7a 10 80       	mov    $0x80107aab,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010427e:	83 f8 05             	cmp    $0x5,%eax
80104281:	77 11                	ja     80104294 <procdump+0x64>
80104283:	8b 14 85 78 7b 10 80 	mov    -0x7fef8488(,%eax,4),%edx
      state = "???";
8010428a:	b8 ab 7a 10 80       	mov    $0x80107aab,%eax
...
80104299:	68 af 7a 10 80       	push   $0x80107aaf
...
801042c0:	e8 1b 04 00 00       	call   801046e0 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042e1:	68 01 75 10 80       	push   $0x80107501
...
80104318:	53                   	push   %ebx
  pushcli();
80104319:	e8 22 04 00 00       	call   80104740 <pushcli>
  c = mycpu();
8010431e:	e8 ed f5 ff ff       	call   80103910 <mycpu>
  p = c->proc;
80104323:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104329:	e8 62 04 00 00       	call   80104790 <popcli>
  struct proc *p;
  int havekids, pid;
  struct proc *curproc = myproc();
...
80104331:	68 20 2d 11 80       	push   $0x80112d20
80104336:	e8 05 05 00 00       	call   80104840 <acquire>
...
8010433e:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104340:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80104345:	eb 17                	jmp    8010435e <waitx+0x4e>
80104347:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010434e:	66 90                	xchg   %ax,%ax
80104350:	81 c3 90 00 00 00    	add    $0x90,%ebx
80104356:	81 fb 54 51 11 80    	cmp    $0x80115154,%ebx
8010435c:	74 1e                	je     8010437c <waitx+0x6c>
      if(p->parent != curproc)
8010435e:	39 73 14             	cmp    %esi,0x14(%ebx)
80104361:	75 ed                	jne    80104350 <waitx+0x40>
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
80104363:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80104367:	74 3f                	je     801043a8 <waitx+0x98>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104369:	81 c3 90 00 00 00    	add    $0x90,%ebx
      havekids = 1;
8010436f:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104374:	81 fb 54 51 11 80    	cmp    $0x80115154,%ebx
8010437a:	75 e2                	jne    8010435e <waitx+0x4e>
        return pid;
      }
    }
...
8010437e:	0f 84 9f 00 00 00    	je     80104423 <waitx+0x113>
80104384:	8b 46 24             	mov    0x24(%esi),%eax
80104387:	85 c0                	test   %eax,%eax
80104389:	0f 85 94 00 00 00    	jne    80104423 <waitx+0x113>
      release(&ptable.lock);
      return -1;
    }
...
80104392:	68 20 2d 11 80       	push   $0x80112d20
80104397:	56                   	push   %esi
80104398:	e8 d3 fb ff ff       	call   80103f70 <sleep>
    havekids = 0;
8010439d:	83 c4 10             	add    $0x10,%esp
801043a0:	eb 9c                	jmp    8010433e <waitx+0x2e>
801043a2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        *wtime = p->etime - p->ctime - p->rtime - p->iotime;
801043a8:	8b 55 08             	mov    0x8(%ebp),%edx
801043ab:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
        kfree(p->kstack);
801043b1:	83 ec 0c             	sub    $0xc,%esp
        *wtime = p->etime - p->ctime - p->rtime - p->iotime;
801043b4:	2b 43 7c             	sub    0x7c(%ebx),%eax
801043b7:	2b 83 84 00 00 00    	sub    0x84(%ebx),%eax
801043bd:	2b 83 88 00 00 00    	sub    0x88(%ebx),%eax
801043c3:	89 02                	mov    %eax,(%edx)
        *rtime = p->rtime;
801043c5:	8b 45 0c             	mov    0xc(%ebp),%eax
801043c8:	8b 93 84 00 00 00    	mov    0x84(%ebx),%edx
801043ce:	89 10                	mov    %edx,(%eax)
        pid = p->pid;
801043d0:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
801043d3:	ff 73 08             	pushl  0x8(%ebx)
801043d6:	e8 95 e0 ff ff       	call   80102470 <kfree>
        freevm(p->pgdir);
801043db:	5a                   	pop    %edx
801043dc:	ff 73 04             	pushl  0x4(%ebx)
        p->kstack = 0;
801043df:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801043e6:	e8 c5 2d 00 00       	call   801071b0 <freevm>
        release(&ptable.lock);
...
8010440b:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80104412:	e8 e9 04 00 00       	call   80104900 <release>
        return pid;
...
80104423:	83 ec 0c             	sub    $0xc,%esp
      return -1;
80104426:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
8010442b:	68 20 2d 11 80       	push   $0x80112d20
80104430:	e8 cb 04 00 00       	call   80104900 <release>
      return -1;
80104435:	83 c4 10             	add    $0x10,%esp
80104438:	eb e0                	jmp    8010441a <waitx+0x10a>
...
8010444b:	fb                   	sti    
  ...
  sti();
  acquire(&ptable.lock);
8010444c:	68 20 2d 11 80       	push   $0x80112d20
  cprintf("name \t pid \t state \t priority\n");
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104451:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
  acquire(&ptable.lock);
80104456:	e8 e5 03 00 00       	call   80104840 <acquire>
  cprintf("name \t pid \t state \t priority\n");
8010445b:	c7 04 24 58 7b 10 80 	movl   $0x80107b58,(%esp)
80104462:	e8 49 c2 ff ff       	call   801006b0 <cprintf>
80104467:	83 c4 10             	add    $0x10,%esp
8010446a:	eb 1c                	jmp    80104488 <cps+0x48>
...
80104478:	74 76                	je     801044f0 <cps+0xb0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010447a:	81 c3 90 00 00 00    	add    $0x90,%ebx
80104480:	81 fb 54 51 11 80    	cmp    $0x80115154,%ebx
80104486:	74 30                	je     801044b8 <cps+0x78>
    if(p->state == SLEEPING)
80104488:	8b 43 0c             	mov    0xc(%ebx),%eax
8010448b:	83 f8 02             	cmp    $0x2,%eax
8010448e:	75 e0                	jne    80104470 <cps+0x30>
      cprintf("%s \t %d \t SLEEPING \t %d \n", p->name, p->pid, p->priority);
80104490:	8d 43 6c             	lea    0x6c(%ebx),%eax
80104493:	ff b3 8c 00 00 00    	pushl  0x8c(%ebx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104499:	81 c3 90 00 00 00    	add    $0x90,%ebx
      cprintf("%s \t %d \t SLEEPING \t %d \n", p->name, p->pid, p->priority);
8010449f:	ff 73 80             	pushl  -0x80(%ebx)
801044a2:	50                   	push   %eax
801044a3:	68 b8 7a 10 80       	push   $0x80107ab8
801044a8:	e8 03 c2 ff ff       	call   801006b0 <cprintf>
801044ad:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801044b0:	81 fb 54 51 11 80    	cmp    $0x80115154,%ebx
801044b6:	75 d0                	jne    80104488 <cps+0x48>
      cprintf("%s \t %d \t RUNNABLE \t %d \n", p->name, p->pid, p->priority);
  }
  release(&ptable.lock);
801044b8:	83 ec 0c             	sub    $0xc,%esp
801044bb:	68 20 2d 11 80       	push   $0x80112d20
801044c0:	e8 3b 04 00 00       	call   80104900 <release>
  return 23;
}
801044c5:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801044c8:	b8 17 00 00 00       	mov    $0x17,%eax
801044cd:	c9                   	leave  
801044ce:	c3                   	ret    
801044cf:	90                   	nop
      cprintf("%s \t %d \t RUNNING \t %d \n", p->name, p->pid, p->priority);
801044d0:	8d 43 6c             	lea    0x6c(%ebx),%eax
801044d3:	ff b3 8c 00 00 00    	pushl  0x8c(%ebx)
801044d9:	ff 73 10             	pushl  0x10(%ebx)
801044dc:	50                   	push   %eax
801044dd:	68 d2 7a 10 80       	push   $0x80107ad2
801044e2:	e8 c9 c1 ff ff       	call   801006b0 <cprintf>
801044e7:	83 c4 10             	add    $0x10,%esp
801044ea:	eb 8e                	jmp    8010447a <cps+0x3a>
801044ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      cprintf("%s \t %d \t RUNNABLE \t %d \n", p->name, p->pid, p->priority);
801044f0:	8d 43 6c             	lea    0x6c(%ebx),%eax
801044f3:	ff b3 8c 00 00 00    	pushl  0x8c(%ebx)
801044f9:	ff 73 10             	pushl  0x10(%ebx)
801044fc:	50                   	push   %eax
801044fd:	68 eb 7a 10 80       	push   $0x80107aeb
80104502:	e8 a9 c1 ff ff       	call   801006b0 <cprintf>
80104507:	83 c4 10             	add    $0x10,%esp
8010450a:	e9 6b ff ff ff       	jmp    8010447a <cps+0x3a>
8010450f:	90                   	nop

80104510 <set_priority>:
...
8010451b:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  ...
  int old_priority = -1;
  acquire(&ptable.lock);
8010451e:	68 20 2d 11 80       	push   $0x80112d20
80104523:	e8 18 03 00 00       	call   80104840 <acquire>
80104528:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010452b:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80104530:	eb 12                	jmp    80104544 <set_priority+0x34>
80104532:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104538:	05 90 00 00 00       	add    $0x90,%eax
8010453d:	3d 54 51 11 80       	cmp    $0x80115154,%eax
80104542:	74 2c                	je     80104570 <set_priority+0x60>
  {
    if(p->pid == pid)
80104544:	39 58 10             	cmp    %ebx,0x10(%eax)
80104547:	75 ef                	jne    80104538 <set_priority+0x28>
    {
      old_priority = p->priority;
      p->priority = new_priority;
80104549:	8b 55 08             	mov    0x8(%ebp),%edx
      old_priority = p->priority;
8010454c:	8b 98 8c 00 00 00    	mov    0x8c(%eax),%ebx
      p->priority = new_priority;
80104552:	89 90 8c 00 00 00    	mov    %edx,0x8c(%eax)
      break;
    }
  }
...
8010455b:	68 20 2d 11 80       	push   $0x80112d20
80104560:	e8 9b 03 00 00       	call   80104900 <release>
  return old_priority;
80104565:	89 d8                	mov    %ebx,%eax
80104567:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010456a:	c9                   	leave  
8010456b:	c3                   	ret    
8010456c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  int old_priority = -1;
80104570:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104575:	eb e1                	jmp    80104558 <set_priority+0x48>
...
8010458e:	68 90 7b 10 80       	push   $0x80107b90
...
801045ed:	e8 7e f9 ff ff       	call   80103f70 <sleep>
  while (lk->locked) {
...
80104648:	e8 e3 fa ff ff       	call   80104130 <wakeup>
  release(&lk->lk);
...
801047d5:	68 9b 7b 10 80       	push   $0x80107b9b
801047da:	e8 b1 bb ff ff       	call   80100390 <panic>
    panic("popcli");
801047df:	83 ec 0c             	sub    $0xc,%esp
801047e2:	68 b2 7b 10 80       	push   $0x80107bb2
...
80104940:	68 c1 7b 10 80       	push   $0x80107bc1
...
80104d40:	8b 14 85 00 7c 10 80 	mov    -0x7fef8400(,%eax,4),%edx
...
80104d68:	68 c9 7b 10 80       	push   $0x80107bc9
...
80104ec4:	68 80 7c 10 80       	push   $0x80107c80
...
80104edc:	68 7f 7c 10 80       	push   $0x80107c7f
...
80104ef1:	68 73 7c 10 80       	push   $0x80107c73
...
80104f0f:	68 82 7c 10 80       	push   $0x80107c82
80104f14:	e8 77 b4 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104f19:	83 ec 0c             	sub    $0xc,%esp
80104f1c:	68 64 7c 10 80       	push   $0x80107c64
...
8010530d:	58                   	pop    %eax
8010530e:	5a                   	pop    %edx
8010530f:	68 80 7c 10 80       	push   $0x80107c80
...
80105328:	68 7f 7c 10 80       	push   $0x80107c7f
...
80105997:	83 ec 08             	sub    $0x8,%esp
  exit();
8010599a:	e8 31 e4 ff ff       	call   80103dd0 <exit>
...
801059b0:	f3 0f 1e fb          	endbr32 
  return wait();
801059b4:	e9 77 e6 ff ff       	jmp    80104030 <wait>
...
801059d0:	e8 5b f2 ff ff       	call   80104c30 <argint>
801059d5:	83 c4 10             	add    $0x10,%esp
801059d8:	85 c0                	test   %eax,%eax
801059da:	78 14                	js     801059f0 <sys_kill+0x30>
    return -1;
  return kill(pid);
801059dc:	83 ec 0c             	sub    $0xc,%esp
801059df:	ff 75 f4             	pushl  -0xc(%ebp)
801059e2:	e8 b9 e7 ff ff       	call   801041a0 <kill>
...
80105a07:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105a0a:	e8 91 df ff ff       	call   801039a0 <myproc>
80105a0f:	8b 40 10             	mov    0x10(%eax),%eax
}
80105a12:	c9                   	leave  
80105a13:	c3                   	ret    
...
80105a31:	e8 fa f1 ff ff       	call   80104c30 <argint>
80105a36:	83 c4 10             	add    $0x10,%esp
80105a39:	85 c0                	test   %eax,%eax
80105a3b:	78 23                	js     80105a60 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105a3d:	e8 5e df ff ff       	call   801039a0 <myproc>
  if(growproc(n) < 0)
80105a42:	83 ec 0c             	sub    $0xc,%esp
  addr = myproc()->sz;
80105a45:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80105a47:	ff 75 f4             	pushl  -0xc(%ebp)
80105a4a:	e8 81 e0 ff ff       	call   80103ad0 <growproc>
80105a4f:	83 c4 10             	add    $0x10,%esp
80105a52:	85 c0                	test   %eax,%eax
80105a54:	78 0a                	js     80105a60 <sys_sbrk+0x40>
    return -1;
  return addr;
}
80105a56:	89 d8                	mov    %ebx,%eax
80105a58:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105a5b:	c9                   	leave  
80105a5c:	c3                   	ret    
80105a5d:	8d 76 00             	lea    0x0(%esi),%esi
    return -1;
80105a60:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105a65:	eb ef                	jmp    80105a56 <sys_sbrk+0x36>
...
80105a81:	e8 aa f1 ff ff       	call   80104c30 <argint>
80105a86:	83 c4 10             	add    $0x10,%esp
80105a89:	85 c0                	test   %eax,%eax
80105a8b:	0f 88 86 00 00 00    	js     80105b17 <sys_sleep+0xa7>
    return -1;
  acquire(&tickslock);
80105a91:	83 ec 0c             	sub    $0xc,%esp
80105a94:	68 60 51 11 80       	push   $0x80115160
80105a99:	e8 a2 ed ff ff       	call   80104840 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105a9e:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105aa1:	8b 1d a0 59 11 80    	mov    0x801159a0,%ebx
  while(ticks - ticks0 < n){
80105aa7:	83 c4 10             	add    $0x10,%esp
80105aaa:	85 d2                	test   %edx,%edx
80105aac:	75 23                	jne    80105ad1 <sys_sleep+0x61>
80105aae:	eb 50                	jmp    80105b00 <sys_sleep+0x90>
    if(myproc()->killed){
      release(&tickslock);
      return -1;
    }
...
80105ab8:	68 a0 59 11 80       	push   $0x801159a0
80105abd:	e8 ae e4 ff ff       	call   80103f70 <sleep>
  while(ticks - ticks0 < n){
80105ac2:	a1 a0 59 11 80       	mov    0x801159a0,%eax
...
80105acf:	73 2f                	jae    80105b00 <sys_sleep+0x90>
    if(myproc()->killed){
80105ad1:	e8 ca de ff ff       	call   801039a0 <myproc>
...
80105ae0:	68 60 51 11 80       	push   $0x80115160
80105ae5:	e8 16 ee ff ff       	call   80104900 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105b03:	68 60 51 11 80       	push   $0x80115160
80105b08:	e8 f3 ed ff ff       	call   80104900 <release>
  return 0;
...
80105b28:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105b2b:	68 60 51 11 80       	push   $0x80115160
80105b30:	e8 0b ed ff ff       	call   80104840 <acquire>
  xticks = ticks;
80105b35:	8b 1d a0 59 11 80    	mov    0x801159a0,%ebx
  release(&tickslock);
80105b3b:	c7 04 24 60 51 11 80 	movl   $0x80115160,(%esp)
80105b42:	e8 b9 ed ff ff       	call   80104900 <release>
  return xticks;
}
80105b47:	89 d8                	mov    %ebx,%eax
...
80105bb0:	f3 0f 1e fb          	endbr32 
  return cps();
80105bb4:	e9 87 e8 ff ff       	jmp    80104440 <cps>
80105bb9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105bc0 <sys_set_priority>:
}
...
80105bd0:	e8 5b f0 ff ff       	call   80104c30 <argint>
80105bd5:	83 c4 10             	add    $0x10,%esp
80105bd8:	85 c0                	test   %eax,%eax
80105bda:	78 2c                	js     80105c08 <sys_set_priority+0x48>
    return -1;
  if(argint(1, &pid) < 0)
...
80105be5:	e8 46 f0 ff ff       	call   80104c30 <argint>
80105bea:	83 c4 10             	add    $0x10,%esp
80105bed:	85 c0                	test   %eax,%eax
80105bef:	78 17                	js     80105c08 <sys_set_priority+0x48>
    return -1;
...
80105bfa:	e8 11 e9 ff ff       	call   80104510 <set_priority>
...
80105c10:	06                   	push   %es
  pushl %fs
80105c11:	0f a0                	push   %fs
  pushl %gs
80105c13:	0f a8                	push   %gs
  pushal
80105c15:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105c16:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105c1a:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105c1c:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105c1e:	54                   	push   %esp
  call trap
80105c1f:	e8 cc 00 00 00       	call   80105cf0 <trap>
  addl $4, %esp
80105c24:	83 c4 04             	add    $0x4,%esp
...
80105c27:	61                   	popa   
  popl %gs
80105c28:	0f a9                	pop    %gs
  popl %fs
80105c2a:	0f a1                	pop    %fs
  popl %es
80105c2c:	07                   	pop    %es
  popl %ds
80105c2d:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105c2e:	83 c4 08             	add    $0x8,%esp
  iret
80105c31:	cf                   	iret   
...
80105c57:	c7 04 c5 a2 51 11 80 	movl   $0x8e000008,-0x7feeae5e(,%eax,8)
80105c5e:	08 00 00 8e 
80105c62:	66 89 14 c5 a0 51 11 	mov    %dx,-0x7feeae60(,%eax,8)
80105c69:	80 
80105c6a:	c1 ea 10             	shr    $0x10,%edx
80105c6d:	66 89 14 c5 a6 51 11 	mov    %dx,-0x7feeae5a(,%eax,8)
80105c74:	80 
  for(i = 0; i < 256; i++)
...
80105c87:	c7 05 a2 53 11 80 08 	movl   $0xef000008,0x801153a2
80105c8e:	00 00 ef 
  initlock(&tickslock, "time");
80105c91:	68 c5 7c 10 80       	push   $0x80107cc5
80105c96:	68 60 51 11 80       	push   $0x80115160
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105c9b:	66 a3 a0 53 11 80    	mov    %ax,0x801153a0
80105ca1:	c1 e8 10             	shr    $0x10,%eax
80105ca4:	66 a3 a6 53 11 80    	mov    %ax,0x801153a6
  initlock(&tickslock, "time");
...
80105ccf:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105cd3:	b8 a0 51 11 80       	mov    $0x801151a0,%eax
...
80105d06:	0f 84 ec 01 00 00    	je     80105ef8 <trap+0x208>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105d14:	3e ff 24 85 6c 7d 10 	notrack jmp *-0x7fef8294(,%eax,4)
80105d1b:	80 
    lapiceoi();
    break;
...
80105d26:	0f 84 2c 02 00 00    	je     80105f58 <trap+0x268>
80105d2c:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105d30:	0f 84 22 02 00 00    	je     80105f58 <trap+0x268>
...
80105d71:	68 28 7d 10 80       	push   $0x80107d28
...
80105daa:	0f 84 80 01 00 00    	je     80105f30 <trap+0x240>
    exit();
...
80105df5:	c3                   	ret    
    ideintr();
80105df6:	e8 e5 c3 ff ff       	call   801021e0 <ideintr>
    lapiceoi();
80105dfb:	e8 c0 ca ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e00:	e8 9b db ff ff       	call   801039a0 <myproc>
80105e05:	85 c0                	test   %eax,%eax
80105e07:	75 8a                	jne    80105d93 <trap+0xa3>
80105e09:	eb a5                	jmp    80105db0 <trap+0xc0>
    if(cpuid() == 0){
80105e0b:	e8 70 db ff ff       	call   80103980 <cpuid>
80105e10:	85 c0                	test   %eax,%eax
80105e12:	75 e7                	jne    80105dfb <trap+0x10b>
      acquire(&tickslock);
80105e14:	83 ec 0c             	sub    $0xc,%esp
80105e17:	68 60 51 11 80       	push   $0x80115160
80105e1c:	e8 1f ea ff ff       	call   80104840 <acquire>
      wakeup(&ticks);
80105e21:	c7 04 24 a0 59 11 80 	movl   $0x801159a0,(%esp)
      ticks++;
80105e28:	83 05 a0 59 11 80 01 	addl   $0x1,0x801159a0
      wakeup(&ticks);
80105e2f:	e8 fc e2 ff ff       	call   80104130 <wakeup>
      release(&tickslock);
80105e34:	c7 04 24 60 51 11 80 	movl   $0x80115160,(%esp)
80105e3b:	e8 c0 ea ff ff       	call   80104900 <release>
      if(myproc())
80105e40:	e8 5b db ff ff       	call   801039a0 <myproc>
80105e45:	83 c4 10             	add    $0x10,%esp
80105e48:	85 c0                	test   %eax,%eax
80105e4a:	74 af                	je     80105dfb <trap+0x10b>
        if(myproc()->state == RUNNING)
80105e4c:	e8 4f db ff ff       	call   801039a0 <myproc>
80105e51:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105e55:	0f 84 ec 00 00 00    	je     80105f47 <trap+0x257>
        else if(myproc()->state == SLEEPING)
80105e5b:	e8 40 db ff ff       	call   801039a0 <myproc>
80105e60:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80105e64:	75 95                	jne    80105dfb <trap+0x10b>
          myproc()->iotime++;
80105e66:	e8 35 db ff ff       	call   801039a0 <myproc>
80105e6b:	83 80 88 00 00 00 01 	addl   $0x1,0x88(%eax)
    lapiceoi();
80105e72:	eb 87                	jmp    80105dfb <trap+0x10b>
    kbdintr();
80105e74:	e8 07 c9 ff ff       	call   80102780 <kbdintr>
    lapiceoi();
80105e79:	e8 42 ca ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e7e:	e8 1d db ff ff       	call   801039a0 <myproc>
80105e83:	85 c0                	test   %eax,%eax
80105e85:	0f 85 08 ff ff ff    	jne    80105d93 <trap+0xa3>
80105e8b:	e9 20 ff ff ff       	jmp    80105db0 <trap+0xc0>
    uartintr();
80105e90:	e8 5b 02 00 00       	call   801060f0 <uartintr>
    lapiceoi();
80105e95:	e8 26 ca ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e9a:	e8 01 db ff ff       	call   801039a0 <myproc>
80105e9f:	85 c0                	test   %eax,%eax
80105ea1:	0f 85 ec fe ff ff    	jne    80105d93 <trap+0xa3>
80105ea7:	e9 04 ff ff ff       	jmp    80105db0 <trap+0xc0>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105eac:	8b 7b 38             	mov    0x38(%ebx),%edi
80105eaf:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105eb3:	e8 c8 da ff ff       	call   80103980 <cpuid>
80105eb8:	57                   	push   %edi
80105eb9:	56                   	push   %esi
80105eba:	50                   	push   %eax
80105ebb:	68 d0 7c 10 80       	push   $0x80107cd0
80105ec0:	e8 eb a7 ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105ec5:	e8 f6 c9 ff ff       	call   801028c0 <lapiceoi>
    break;
80105eca:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ecd:	e8 ce da ff ff       	call   801039a0 <myproc>
80105ed2:	85 c0                	test   %eax,%eax
80105ed4:	0f 85 b9 fe ff ff    	jne    80105d93 <trap+0xa3>
80105eda:	e9 d1 fe ff ff       	jmp    80105db0 <trap+0xc0>
80105edf:	90                   	nop
  if(myproc() && myproc()->state == RUNNING &&
80105ee0:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105ee4:	0f 85 de fe ff ff    	jne    80105dc8 <trap+0xd8>
    yield();
80105eea:	e8 31 e0 ff ff       	call   80103f20 <yield>
80105eef:	e9 d4 fe ff ff       	jmp    80105dc8 <trap+0xd8>
80105ef4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105ef8:	e8 a3 da ff ff       	call   801039a0 <myproc>
80105efd:	8b 70 24             	mov    0x24(%eax),%esi
80105f00:	85 f6                	test   %esi,%esi
80105f02:	75 3c                	jne    80105f40 <trap+0x250>
    myproc()->tf = tf;
80105f04:	e8 97 da ff ff       	call   801039a0 <myproc>
80105f09:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105f0c:	e8 0f ee ff ff       	call   80104d20 <syscall>
    if(myproc()->killed)
80105f11:	e8 8a da ff ff       	call   801039a0 <myproc>
80105f16:	8b 48 24             	mov    0x24(%eax),%ecx
80105f19:	85 c9                	test   %ecx,%ecx
80105f1b:	0f 84 cd fe ff ff    	je     80105dee <trap+0xfe>
}
...
80105f27:	5d                   	pop    %ebp
      exit();
80105f28:	e9 a3 de ff ff       	jmp    80103dd0 <exit>
80105f2d:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
80105f30:	e8 9b de ff ff       	call   80103dd0 <exit>
80105f35:	e9 76 fe ff ff       	jmp    80105db0 <trap+0xc0>
80105f3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105f40:	e8 8b de ff ff       	call   80103dd0 <exit>
80105f45:	eb bd                	jmp    80105f04 <trap+0x214>
          myproc()->rtime++;
80105f47:	e8 54 da ff ff       	call   801039a0 <myproc>
80105f4c:	83 80 84 00 00 00 01 	addl   $0x1,0x84(%eax)
80105f53:	e9 a3 fe ff ff       	jmp    80105dfb <trap+0x10b>
80105f58:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105f5b:	e8 20 da ff ff       	call   80103980 <cpuid>
80105f60:	83 ec 0c             	sub    $0xc,%esp
80105f63:	56                   	push   %esi
80105f64:	57                   	push   %edi
80105f65:	50                   	push   %eax
80105f66:	ff 73 30             	pushl  0x30(%ebx)
80105f69:	68 f4 7c 10 80       	push   $0x80107cf4
80105f6e:	e8 3d a7 ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105f73:	83 c4 14             	add    $0x14,%esp
80105f76:	68 ca 7c 10 80       	push   $0x80107cca
80105f7b:	e8 10 a4 ff ff       	call   80100390 <panic>
...
80106073:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80106078:	bb ec 7d 10 80       	mov    $0x80107dec,%ebx
  ioapicenable(IRQ_COM1, 0);
...
8010610b:	6a 00                	push   $0x0
  jmp alltraps
8010610d:	e9 fd fa ff ff       	jmp    80105c0f <alltraps>
...
80106114:	6a 01                	push   $0x1
  jmp alltraps
80106116:	e9 f4 fa ff ff       	jmp    80105c0f <alltraps>
...
8010611d:	6a 02                	push   $0x2
  jmp alltraps
8010611f:	e9 eb fa ff ff       	jmp    80105c0f <alltraps>
...
80106126:	6a 03                	push   $0x3
  jmp alltraps
80106128:	e9 e2 fa ff ff       	jmp    80105c0f <alltraps>
...
8010612f:	6a 04                	push   $0x4
  jmp alltraps
80106131:	e9 d9 fa ff ff       	jmp    80105c0f <alltraps>
...
80106138:	6a 05                	push   $0x5
  jmp alltraps
8010613a:	e9 d0 fa ff ff       	jmp    80105c0f <alltraps>
...
80106141:	6a 06                	push   $0x6
  jmp alltraps
80106143:	e9 c7 fa ff ff       	jmp    80105c0f <alltraps>
...
8010614a:	6a 07                	push   $0x7
  jmp alltraps
8010614c:	e9 be fa ff ff       	jmp    80105c0f <alltraps>
...
80106151:	6a 08                	push   $0x8
  jmp alltraps
80106153:	e9 b7 fa ff ff       	jmp    80105c0f <alltraps>
...
8010615a:	6a 09                	push   $0x9
  jmp alltraps
8010615c:	e9 ae fa ff ff       	jmp    80105c0f <alltraps>
...
80106161:	6a 0a                	push   $0xa
  jmp alltraps
80106163:	e9 a7 fa ff ff       	jmp    80105c0f <alltraps>
...
80106168:	6a 0b                	push   $0xb
  jmp alltraps
8010616a:	e9 a0 fa ff ff       	jmp    80105c0f <alltraps>
...
8010616f:	6a 0c                	push   $0xc
  jmp alltraps
80106171:	e9 99 fa ff ff       	jmp    80105c0f <alltraps>
...
80106176:	6a 0d                	push   $0xd
  jmp alltraps
80106178:	e9 92 fa ff ff       	jmp    80105c0f <alltraps>
...
8010617d:	6a 0e                	push   $0xe
  jmp alltraps
8010617f:	e9 8b fa ff ff       	jmp    80105c0f <alltraps>
...
80106186:	6a 0f                	push   $0xf
  jmp alltraps
80106188:	e9 82 fa ff ff       	jmp    80105c0f <alltraps>
...
8010618f:	6a 10                	push   $0x10
  jmp alltraps
80106191:	e9 79 fa ff ff       	jmp    80105c0f <alltraps>
...
80106196:	6a 11                	push   $0x11
  jmp alltraps
80106198:	e9 72 fa ff ff       	jmp    80105c0f <alltraps>
...
8010619f:	6a 12                	push   $0x12
  jmp alltraps
801061a1:	e9 69 fa ff ff       	jmp    80105c0f <alltraps>
...
801061a8:	6a 13                	push   $0x13
  jmp alltraps
801061aa:	e9 60 fa ff ff       	jmp    80105c0f <alltraps>
...
801061b1:	6a 14                	push   $0x14
  jmp alltraps
801061b3:	e9 57 fa ff ff       	jmp    80105c0f <alltraps>
...
801061ba:	6a 15                	push   $0x15
  jmp alltraps
801061bc:	e9 4e fa ff ff       	jmp    80105c0f <alltraps>
...
801061c3:	6a 16                	push   $0x16
  jmp alltraps
801061c5:	e9 45 fa ff ff       	jmp    80105c0f <alltraps>
...
801061cc:	6a 17                	push   $0x17
  jmp alltraps
801061ce:	e9 3c fa ff ff       	jmp    80105c0f <alltraps>
...
801061d5:	6a 18                	push   $0x18
  jmp alltraps
801061d7:	e9 33 fa ff ff       	jmp    80105c0f <alltraps>
...
801061de:	6a 19                	push   $0x19
  jmp alltraps
801061e0:	e9 2a fa ff ff       	jmp    80105c0f <alltraps>
...
801061e7:	6a 1a                	push   $0x1a
  jmp alltraps
801061e9:	e9 21 fa ff ff       	jmp    80105c0f <alltraps>
...
801061f0:	6a 1b                	push   $0x1b
  jmp alltraps
801061f2:	e9 18 fa ff ff       	jmp    80105c0f <alltraps>
...
801061f9:	6a 1c                	push   $0x1c
  jmp alltraps
801061fb:	e9 0f fa ff ff       	jmp    80105c0f <alltraps>
...
80106202:	6a 1d                	push   $0x1d
  jmp alltraps
80106204:	e9 06 fa ff ff       	jmp    80105c0f <alltraps>
...
8010620b:	6a 1e                	push   $0x1e
  jmp alltraps
8010620d:	e9 fd f9 ff ff       	jmp    80105c0f <alltraps>
...
80106214:	6a 1f                	push   $0x1f
  jmp alltraps
80106216:	e9 f4 f9 ff ff       	jmp    80105c0f <alltraps>
...
8010621d:	6a 20                	push   $0x20
  jmp alltraps
8010621f:	e9 eb f9 ff ff       	jmp    80105c0f <alltraps>
...
80106226:	6a 21                	push   $0x21
  jmp alltraps
80106228:	e9 e2 f9 ff ff       	jmp    80105c0f <alltraps>
...
8010622f:	6a 22                	push   $0x22
  jmp alltraps
80106231:	e9 d9 f9 ff ff       	jmp    80105c0f <alltraps>
...
80106238:	6a 23                	push   $0x23
  jmp alltraps
8010623a:	e9 d0 f9 ff ff       	jmp    80105c0f <alltraps>
...
80106241:	6a 24                	push   $0x24
  jmp alltraps
80106243:	e9 c7 f9 ff ff       	jmp    80105c0f <alltraps>
...
8010624a:	6a 25                	push   $0x25
  jmp alltraps
8010624c:	e9 be f9 ff ff       	jmp    80105c0f <alltraps>
...
80106253:	6a 26                	push   $0x26
  jmp alltraps
80106255:	e9 b5 f9 ff ff       	jmp    80105c0f <alltraps>
...
8010625c:	6a 27                	push   $0x27
  jmp alltraps
8010625e:	e9 ac f9 ff ff       	jmp    80105c0f <alltraps>
...
80106265:	6a 28                	push   $0x28
  jmp alltraps
80106267:	e9 a3 f9 ff ff       	jmp    80105c0f <alltraps>
...
8010626e:	6a 29                	push   $0x29
  jmp alltraps
80106270:	e9 9a f9 ff ff       	jmp    80105c0f <alltraps>
...
80106277:	6a 2a                	push   $0x2a
  jmp alltraps
80106279:	e9 91 f9 ff ff       	jmp    80105c0f <alltraps>
...
80106280:	6a 2b                	push   $0x2b
  jmp alltraps
80106282:	e9 88 f9 ff ff       	jmp    80105c0f <alltraps>
...
80106289:	6a 2c                	push   $0x2c
  jmp alltraps
8010628b:	e9 7f f9 ff ff       	jmp    80105c0f <alltraps>
...
80106292:	6a 2d                	push   $0x2d
  jmp alltraps
80106294:	e9 76 f9 ff ff       	jmp    80105c0f <alltraps>
...
8010629b:	6a 2e                	push   $0x2e
  jmp alltraps
8010629d:	e9 6d f9 ff ff       	jmp    80105c0f <alltraps>
...
801062a4:	6a 2f                	push   $0x2f
  jmp alltraps
801062a6:	e9 64 f9 ff ff       	jmp    80105c0f <alltraps>
...
801062ad:	6a 30                	push   $0x30
  jmp alltraps
801062af:	e9 5b f9 ff ff       	jmp    80105c0f <alltraps>
...
801062b6:	6a 31                	push   $0x31
  jmp alltraps
801062b8:	e9 52 f9 ff ff       	jmp    80105c0f <alltraps>
...
801062bf:	6a 32                	push   $0x32
  jmp alltraps
801062c1:	e9 49 f9 ff ff       	jmp    80105c0f <alltraps>
...
801062c8:	6a 33                	push   $0x33
  jmp alltraps
801062ca:	e9 40 f9 ff ff       	jmp    80105c0f <alltraps>
...
801062d1:	6a 34                	push   $0x34
  jmp alltraps
801062d3:	e9 37 f9 ff ff       	jmp    80105c0f <alltraps>
...
801062da:	6a 35                	push   $0x35
  jmp alltraps
801062dc:	e9 2e f9 ff ff       	jmp    80105c0f <alltraps>
...
801062e3:	6a 36                	push   $0x36
  jmp alltraps
801062e5:	e9 25 f9 ff ff       	jmp    80105c0f <alltraps>
...
801062ec:	6a 37                	push   $0x37
  jmp alltraps
801062ee:	e9 1c f9 ff ff       	jmp    80105c0f <alltraps>
...
801062f5:	6a 38                	push   $0x38
  jmp alltraps
801062f7:	e9 13 f9 ff ff       	jmp    80105c0f <alltraps>
...
801062fe:	6a 39                	push   $0x39
  jmp alltraps
80106300:	e9 0a f9 ff ff       	jmp    80105c0f <alltraps>
...
80106307:	6a 3a                	push   $0x3a
  jmp alltraps
80106309:	e9 01 f9 ff ff       	jmp    80105c0f <alltraps>
...
80106310:	6a 3b                	push   $0x3b
  jmp alltraps
80106312:	e9 f8 f8 ff ff       	jmp    80105c0f <alltraps>
...
80106319:	6a 3c                	push   $0x3c
  jmp alltraps
8010631b:	e9 ef f8 ff ff       	jmp    80105c0f <alltraps>
...
80106322:	6a 3d                	push   $0x3d
  jmp alltraps
80106324:	e9 e6 f8 ff ff       	jmp    80105c0f <alltraps>
...
8010632b:	6a 3e                	push   $0x3e
  jmp alltraps
8010632d:	e9 dd f8 ff ff       	jmp    80105c0f <alltraps>
...
80106334:	6a 3f                	push   $0x3f
  jmp alltraps
80106336:	e9 d4 f8 ff ff       	jmp    80105c0f <alltraps>
...
8010633d:	6a 40                	push   $0x40
  jmp alltraps
8010633f:	e9 cb f8 ff ff       	jmp    80105c0f <alltraps>
...
80106346:	6a 41                	push   $0x41
  jmp alltraps
80106348:	e9 c2 f8 ff ff       	jmp    80105c0f <alltraps>
...
8010634f:	6a 42                	push   $0x42
  jmp alltraps
80106351:	e9 b9 f8 ff ff       	jmp    80105c0f <alltraps>
...
80106358:	6a 43                	push   $0x43
  jmp alltraps
8010635a:	e9 b0 f8 ff ff       	jmp    80105c0f <alltraps>
...
80106361:	6a 44                	push   $0x44
  jmp alltraps
80106363:	e9 a7 f8 ff ff       	jmp    80105c0f <alltraps>
...
8010636a:	6a 45                	push   $0x45
  jmp alltraps
8010636c:	e9 9e f8 ff ff       	jmp    80105c0f <alltraps>
...
80106373:	6a 46                	push   $0x46
  jmp alltraps
80106375:	e9 95 f8 ff ff       	jmp    80105c0f <alltraps>
...
8010637c:	6a 47                	push   $0x47
  jmp alltraps
8010637e:	e9 8c f8 ff ff       	jmp    80105c0f <alltraps>
...
80106385:	6a 48                	push   $0x48
  jmp alltraps
80106387:	e9 83 f8 ff ff       	jmp    80105c0f <alltraps>
...
8010638e:	6a 49                	push   $0x49
  jmp alltraps
80106390:	e9 7a f8 ff ff       	jmp    80105c0f <alltraps>
...
80106397:	6a 4a                	push   $0x4a
  jmp alltraps
80106399:	e9 71 f8 ff ff       	jmp    80105c0f <alltraps>
...
801063a0:	6a 4b                	push   $0x4b
  jmp alltraps
801063a2:	e9 68 f8 ff ff       	jmp    80105c0f <alltraps>
...
801063a9:	6a 4c                	push   $0x4c
  jmp alltraps
801063ab:	e9 5f f8 ff ff       	jmp    80105c0f <alltraps>
...
801063b2:	6a 4d                	push   $0x4d
  jmp alltraps
801063b4:	e9 56 f8 ff ff       	jmp    80105c0f <alltraps>
...
801063bb:	6a 4e                	push   $0x4e
  jmp alltraps
801063bd:	e9 4d f8 ff ff       	jmp    80105c0f <alltraps>
...
801063c4:	6a 4f                	push   $0x4f
  jmp alltraps
801063c6:	e9 44 f8 ff ff       	jmp    80105c0f <alltraps>
...
801063cd:	6a 50                	push   $0x50
  jmp alltraps
801063cf:	e9 3b f8 ff ff       	jmp    80105c0f <alltraps>
...
801063d6:	6a 51                	push   $0x51
  jmp alltraps
801063d8:	e9 32 f8 ff ff       	jmp    80105c0f <alltraps>
...
801063df:	6a 52                	push   $0x52
  jmp alltraps
801063e1:	e9 29 f8 ff ff       	jmp    80105c0f <alltraps>
...
801063e8:	6a 53                	push   $0x53
  jmp alltraps
801063ea:	e9 20 f8 ff ff       	jmp    80105c0f <alltraps>
...
801063f1:	6a 54                	push   $0x54
  jmp alltraps
801063f3:	e9 17 f8 ff ff       	jmp    80105c0f <alltraps>
...
801063fa:	6a 55                	push   $0x55
  jmp alltraps
801063fc:	e9 0e f8 ff ff       	jmp    80105c0f <alltraps>
...
80106403:	6a 56                	push   $0x56
  jmp alltraps
80106405:	e9 05 f8 ff ff       	jmp    80105c0f <alltraps>
...
8010640c:	6a 57                	push   $0x57
  jmp alltraps
8010640e:	e9 fc f7 ff ff       	jmp    80105c0f <alltraps>
...
80106415:	6a 58                	push   $0x58
  jmp alltraps
80106417:	e9 f3 f7 ff ff       	jmp    80105c0f <alltraps>
...
8010641e:	6a 59                	push   $0x59
  jmp alltraps
80106420:	e9 ea f7 ff ff       	jmp    80105c0f <alltraps>
...
80106427:	6a 5a                	push   $0x5a
  jmp alltraps
80106429:	e9 e1 f7 ff ff       	jmp    80105c0f <alltraps>
...
80106430:	6a 5b                	push   $0x5b
  jmp alltraps
80106432:	e9 d8 f7 ff ff       	jmp    80105c0f <alltraps>
...
80106439:	6a 5c                	push   $0x5c
  jmp alltraps
8010643b:	e9 cf f7 ff ff       	jmp    80105c0f <alltraps>
...
80106442:	6a 5d                	push   $0x5d
  jmp alltraps
80106444:	e9 c6 f7 ff ff       	jmp    80105c0f <alltraps>
...
8010644b:	6a 5e                	push   $0x5e
  jmp alltraps
8010644d:	e9 bd f7 ff ff       	jmp    80105c0f <alltraps>
...
80106454:	6a 5f                	push   $0x5f
  jmp alltraps
80106456:	e9 b4 f7 ff ff       	jmp    80105c0f <alltraps>
...
8010645d:	6a 60                	push   $0x60
  jmp alltraps
8010645f:	e9 ab f7 ff ff       	jmp    80105c0f <alltraps>
...
80106466:	6a 61                	push   $0x61
  jmp alltraps
80106468:	e9 a2 f7 ff ff       	jmp    80105c0f <alltraps>
...
8010646f:	6a 62                	push   $0x62
  jmp alltraps
80106471:	e9 99 f7 ff ff       	jmp    80105c0f <alltraps>
...
80106478:	6a 63                	push   $0x63
  jmp alltraps
8010647a:	e9 90 f7 ff ff       	jmp    80105c0f <alltraps>
...
80106481:	6a 64                	push   $0x64
  jmp alltraps
80106483:	e9 87 f7 ff ff       	jmp    80105c0f <alltraps>
...
8010648a:	6a 65                	push   $0x65
  jmp alltraps
8010648c:	e9 7e f7 ff ff       	jmp    80105c0f <alltraps>
...
80106493:	6a 66                	push   $0x66
  jmp alltraps
80106495:	e9 75 f7 ff ff       	jmp    80105c0f <alltraps>
...
8010649c:	6a 67                	push   $0x67
  jmp alltraps
8010649e:	e9 6c f7 ff ff       	jmp    80105c0f <alltraps>
...
801064a5:	6a 68                	push   $0x68
  jmp alltraps
801064a7:	e9 63 f7 ff ff       	jmp    80105c0f <alltraps>
...
801064ae:	6a 69                	push   $0x69
  jmp alltraps
801064b0:	e9 5a f7 ff ff       	jmp    80105c0f <alltraps>
...
801064b7:	6a 6a                	push   $0x6a
  jmp alltraps
801064b9:	e9 51 f7 ff ff       	jmp    80105c0f <alltraps>
...
801064c0:	6a 6b                	push   $0x6b
  jmp alltraps
801064c2:	e9 48 f7 ff ff       	jmp    80105c0f <alltraps>
...
801064c9:	6a 6c                	push   $0x6c
  jmp alltraps
801064cb:	e9 3f f7 ff ff       	jmp    80105c0f <alltraps>
...
801064d2:	6a 6d                	push   $0x6d
  jmp alltraps
801064d4:	e9 36 f7 ff ff       	jmp    80105c0f <alltraps>
...
801064db:	6a 6e                	push   $0x6e
  jmp alltraps
801064dd:	e9 2d f7 ff ff       	jmp    80105c0f <alltraps>
...
801064e4:	6a 6f                	push   $0x6f
  jmp alltraps
801064e6:	e9 24 f7 ff ff       	jmp    80105c0f <alltraps>
...
801064ed:	6a 70                	push   $0x70
  jmp alltraps
801064ef:	e9 1b f7 ff ff       	jmp    80105c0f <alltraps>
...
801064f6:	6a 71                	push   $0x71
  jmp alltraps
801064f8:	e9 12 f7 ff ff       	jmp    80105c0f <alltraps>
...
801064ff:	6a 72                	push   $0x72
  jmp alltraps
80106501:	e9 09 f7 ff ff       	jmp    80105c0f <alltraps>
...
80106508:	6a 73                	push   $0x73
  jmp alltraps
8010650a:	e9 00 f7 ff ff       	jmp    80105c0f <alltraps>
...
80106511:	6a 74                	push   $0x74
  jmp alltraps
80106513:	e9 f7 f6 ff ff       	jmp    80105c0f <alltraps>
...
8010651a:	6a 75                	push   $0x75
  jmp alltraps
8010651c:	e9 ee f6 ff ff       	jmp    80105c0f <alltraps>
...
80106523:	6a 76                	push   $0x76
  jmp alltraps
80106525:	e9 e5 f6 ff ff       	jmp    80105c0f <alltraps>
...
8010652c:	6a 77                	push   $0x77
  jmp alltraps
8010652e:	e9 dc f6 ff ff       	jmp    80105c0f <alltraps>
...
80106535:	6a 78                	push   $0x78
  jmp alltraps
80106537:	e9 d3 f6 ff ff       	jmp    80105c0f <alltraps>
...
8010653e:	6a 79                	push   $0x79
  jmp alltraps
80106540:	e9 ca f6 ff ff       	jmp    80105c0f <alltraps>
...
80106547:	6a 7a                	push   $0x7a
  jmp alltraps
80106549:	e9 c1 f6 ff ff       	jmp    80105c0f <alltraps>
...
80106550:	6a 7b                	push   $0x7b
  jmp alltraps
80106552:	e9 b8 f6 ff ff       	jmp    80105c0f <alltraps>
...
80106559:	6a 7c                	push   $0x7c
  jmp alltraps
8010655b:	e9 af f6 ff ff       	jmp    80105c0f <alltraps>
...
80106562:	6a 7d                	push   $0x7d
  jmp alltraps
80106564:	e9 a6 f6 ff ff       	jmp    80105c0f <alltraps>
...
8010656b:	6a 7e                	push   $0x7e
  jmp alltraps
8010656d:	e9 9d f6 ff ff       	jmp    80105c0f <alltraps>
...
80106574:	6a 7f                	push   $0x7f
  jmp alltraps
80106576:	e9 94 f6 ff ff       	jmp    80105c0f <alltraps>
...
8010657d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106582:	e9 88 f6 ff ff       	jmp    80105c0f <alltraps>
...
80106589:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010658e:	e9 7c f6 ff ff       	jmp    80105c0f <alltraps>
...
80106595:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010659a:	e9 70 f6 ff ff       	jmp    80105c0f <alltraps>
...
801065a1:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801065a6:	e9 64 f6 ff ff       	jmp    80105c0f <alltraps>
...
801065ad:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801065b2:	e9 58 f6 ff ff       	jmp    80105c0f <alltraps>
...
801065b9:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801065be:	e9 4c f6 ff ff       	jmp    80105c0f <alltraps>
...
801065c5:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801065ca:	e9 40 f6 ff ff       	jmp    80105c0f <alltraps>
...
801065d1:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801065d6:	e9 34 f6 ff ff       	jmp    80105c0f <alltraps>
...
801065dd:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801065e2:	e9 28 f6 ff ff       	jmp    80105c0f <alltraps>
...
801065e9:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801065ee:	e9 1c f6 ff ff       	jmp    80105c0f <alltraps>
...
801065f5:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801065fa:	e9 10 f6 ff ff       	jmp    80105c0f <alltraps>
...
80106601:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106606:	e9 04 f6 ff ff       	jmp    80105c0f <alltraps>
...
8010660d:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106612:	e9 f8 f5 ff ff       	jmp    80105c0f <alltraps>
...
80106619:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010661e:	e9 ec f5 ff ff       	jmp    80105c0f <alltraps>
...
80106625:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010662a:	e9 e0 f5 ff ff       	jmp    80105c0f <alltraps>
...
80106631:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106636:	e9 d4 f5 ff ff       	jmp    80105c0f <alltraps>
...
8010663d:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80106642:	e9 c8 f5 ff ff       	jmp    80105c0f <alltraps>
...
80106649:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010664e:	e9 bc f5 ff ff       	jmp    80105c0f <alltraps>
...
80106655:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010665a:	e9 b0 f5 ff ff       	jmp    80105c0f <alltraps>
...
80106661:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106666:	e9 a4 f5 ff ff       	jmp    80105c0f <alltraps>
...
8010666d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106672:	e9 98 f5 ff ff       	jmp    80105c0f <alltraps>
...
80106679:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010667e:	e9 8c f5 ff ff       	jmp    80105c0f <alltraps>
...
80106685:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010668a:	e9 80 f5 ff ff       	jmp    80105c0f <alltraps>
...
80106691:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106696:	e9 74 f5 ff ff       	jmp    80105c0f <alltraps>
...
8010669d:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801066a2:	e9 68 f5 ff ff       	jmp    80105c0f <alltraps>
...
801066a9:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801066ae:	e9 5c f5 ff ff       	jmp    80105c0f <alltraps>
...
801066b5:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801066ba:	e9 50 f5 ff ff       	jmp    80105c0f <alltraps>
...
801066c1:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801066c6:	e9 44 f5 ff ff       	jmp    80105c0f <alltraps>
...
801066cd:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801066d2:	e9 38 f5 ff ff       	jmp    80105c0f <alltraps>
...
801066d9:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801066de:	e9 2c f5 ff ff       	jmp    80105c0f <alltraps>
...
801066e5:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801066ea:	e9 20 f5 ff ff       	jmp    80105c0f <alltraps>
...
801066f1:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801066f6:	e9 14 f5 ff ff       	jmp    80105c0f <alltraps>
...
801066fd:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80106702:	e9 08 f5 ff ff       	jmp    80105c0f <alltraps>
...
80106709:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010670e:	e9 fc f4 ff ff       	jmp    80105c0f <alltraps>
...
80106715:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010671a:	e9 f0 f4 ff ff       	jmp    80105c0f <alltraps>
...
80106721:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106726:	e9 e4 f4 ff ff       	jmp    80105c0f <alltraps>
...
8010672d:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80106732:	e9 d8 f4 ff ff       	jmp    80105c0f <alltraps>
...
80106739:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010673e:	e9 cc f4 ff ff       	jmp    80105c0f <alltraps>
...
80106745:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010674a:	e9 c0 f4 ff ff       	jmp    80105c0f <alltraps>
...
80106751:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106756:	e9 b4 f4 ff ff       	jmp    80105c0f <alltraps>
...
8010675d:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80106762:	e9 a8 f4 ff ff       	jmp    80105c0f <alltraps>
...
80106769:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010676e:	e9 9c f4 ff ff       	jmp    80105c0f <alltraps>
...
80106775:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010677a:	e9 90 f4 ff ff       	jmp    80105c0f <alltraps>
...
80106781:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106786:	e9 84 f4 ff ff       	jmp    80105c0f <alltraps>
...
8010678d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106792:	e9 78 f4 ff ff       	jmp    80105c0f <alltraps>
...
80106799:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010679e:	e9 6c f4 ff ff       	jmp    80105c0f <alltraps>
...
801067a5:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801067aa:	e9 60 f4 ff ff       	jmp    80105c0f <alltraps>
...
801067b1:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801067b6:	e9 54 f4 ff ff       	jmp    80105c0f <alltraps>
...
801067bd:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801067c2:	e9 48 f4 ff ff       	jmp    80105c0f <alltraps>
...
801067c9:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801067ce:	e9 3c f4 ff ff       	jmp    80105c0f <alltraps>
...
801067d5:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801067da:	e9 30 f4 ff ff       	jmp    80105c0f <alltraps>
...
801067e1:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801067e6:	e9 24 f4 ff ff       	jmp    80105c0f <alltraps>
...
801067ed:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801067f2:	e9 18 f4 ff ff       	jmp    80105c0f <alltraps>
...
801067f9:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801067fe:	e9 0c f4 ff ff       	jmp    80105c0f <alltraps>
...
80106805:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010680a:	e9 00 f4 ff ff       	jmp    80105c0f <alltraps>
...
80106811:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106816:	e9 f4 f3 ff ff       	jmp    80105c0f <alltraps>
...
8010681d:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80106822:	e9 e8 f3 ff ff       	jmp    80105c0f <alltraps>
...
80106829:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010682e:	e9 dc f3 ff ff       	jmp    80105c0f <alltraps>
...
80106835:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
8010683a:	e9 d0 f3 ff ff       	jmp    80105c0f <alltraps>
...
80106841:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106846:	e9 c4 f3 ff ff       	jmp    80105c0f <alltraps>
...
8010684d:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106852:	e9 b8 f3 ff ff       	jmp    80105c0f <alltraps>
...
80106859:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010685e:	e9 ac f3 ff ff       	jmp    80105c0f <alltraps>
...
80106865:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
8010686a:	e9 a0 f3 ff ff       	jmp    80105c0f <alltraps>
...
80106871:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106876:	e9 94 f3 ff ff       	jmp    80105c0f <alltraps>
...
8010687d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106882:	e9 88 f3 ff ff       	jmp    80105c0f <alltraps>
...
80106889:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010688e:	e9 7c f3 ff ff       	jmp    80105c0f <alltraps>
...
80106895:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010689a:	e9 70 f3 ff ff       	jmp    80105c0f <alltraps>
...
801068a1:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801068a6:	e9 64 f3 ff ff       	jmp    80105c0f <alltraps>
...
801068ad:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801068b2:	e9 58 f3 ff ff       	jmp    80105c0f <alltraps>
...
801068b9:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801068be:	e9 4c f3 ff ff       	jmp    80105c0f <alltraps>
...
801068c5:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801068ca:	e9 40 f3 ff ff       	jmp    80105c0f <alltraps>
...
801068d1:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801068d6:	e9 34 f3 ff ff       	jmp    80105c0f <alltraps>
...
801068dd:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801068e2:	e9 28 f3 ff ff       	jmp    80105c0f <alltraps>
...
801068e9:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801068ee:	e9 1c f3 ff ff       	jmp    80105c0f <alltraps>
...
801068f5:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801068fa:	e9 10 f3 ff ff       	jmp    80105c0f <alltraps>
...
80106901:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106906:	e9 04 f3 ff ff       	jmp    80105c0f <alltraps>
...
8010690d:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106912:	e9 f8 f2 ff ff       	jmp    80105c0f <alltraps>
...
80106919:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010691e:	e9 ec f2 ff ff       	jmp    80105c0f <alltraps>
...
80106925:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
8010692a:	e9 e0 f2 ff ff       	jmp    80105c0f <alltraps>
...
80106931:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106936:	e9 d4 f2 ff ff       	jmp    80105c0f <alltraps>
...
8010693d:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106942:	e9 c8 f2 ff ff       	jmp    80105c0f <alltraps>
...
80106949:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010694e:	e9 bc f2 ff ff       	jmp    80105c0f <alltraps>
...
80106955:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
8010695a:	e9 b0 f2 ff ff       	jmp    80105c0f <alltraps>
...
80106961:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106966:	e9 a4 f2 ff ff       	jmp    80105c0f <alltraps>
...
8010696d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106972:	e9 98 f2 ff ff       	jmp    80105c0f <alltraps>
...
80106979:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010697e:	e9 8c f2 ff ff       	jmp    80105c0f <alltraps>
...
80106985:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
8010698a:	e9 80 f2 ff ff       	jmp    80105c0f <alltraps>
...
80106991:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106996:	e9 74 f2 ff ff       	jmp    80105c0f <alltraps>
...
8010699d:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801069a2:	e9 68 f2 ff ff       	jmp    80105c0f <alltraps>
...
801069a9:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801069ae:	e9 5c f2 ff ff       	jmp    80105c0f <alltraps>
...
801069b5:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801069ba:	e9 50 f2 ff ff       	jmp    80105c0f <alltraps>
...
801069c1:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801069c6:	e9 44 f2 ff ff       	jmp    80105c0f <alltraps>
...
801069cd:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801069d2:	e9 38 f2 ff ff       	jmp    80105c0f <alltraps>
...
801069d9:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801069de:	e9 2c f2 ff ff       	jmp    80105c0f <alltraps>
...
801069e5:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801069ea:	e9 20 f2 ff ff       	jmp    80105c0f <alltraps>
...
801069f1:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801069f6:	e9 14 f2 ff ff       	jmp    80105c0f <alltraps>
...
801069fd:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106a02:	e9 08 f2 ff ff       	jmp    80105c0f <alltraps>
...
80106a09:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106a0e:	e9 fc f1 ff ff       	jmp    80105c0f <alltraps>
...
80106a15:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106a1a:	e9 f0 f1 ff ff       	jmp    80105c0f <alltraps>
...
80106a21:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106a26:	e9 e4 f1 ff ff       	jmp    80105c0f <alltraps>
...
80106a2d:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106a32:	e9 d8 f1 ff ff       	jmp    80105c0f <alltraps>
...
80106a39:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106a3e:	e9 cc f1 ff ff       	jmp    80105c0f <alltraps>
...
80106a45:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106a4a:	e9 c0 f1 ff ff       	jmp    80105c0f <alltraps>
...
80106a51:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106a56:	e9 b4 f1 ff ff       	jmp    80105c0f <alltraps>
...
80106a5d:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106a62:	e9 a8 f1 ff ff       	jmp    80105c0f <alltraps>
...
80106a69:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106a6e:	e9 9c f1 ff ff       	jmp    80105c0f <alltraps>
...
80106a75:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106a7a:	e9 90 f1 ff ff       	jmp    80105c0f <alltraps>
...
80106a81:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106a86:	e9 84 f1 ff ff       	jmp    80105c0f <alltraps>
...
80106a8d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106a92:	e9 78 f1 ff ff       	jmp    80105c0f <alltraps>
...
80106a99:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106a9e:	e9 6c f1 ff ff       	jmp    80105c0f <alltraps>
...
80106aa5:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106aaa:	e9 60 f1 ff ff       	jmp    80105c0f <alltraps>
...
80106ab1:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106ab6:	e9 54 f1 ff ff       	jmp    80105c0f <alltraps>
...
80106abd:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106ac2:	e9 48 f1 ff ff       	jmp    80105c0f <alltraps>
...
80106ac9:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106ace:	e9 3c f1 ff ff       	jmp    80105c0f <alltraps>
...
80106ad5:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106ada:	e9 30 f1 ff ff       	jmp    80105c0f <alltraps>
...
80106ae1:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106ae6:	e9 24 f1 ff ff       	jmp    80105c0f <alltraps>
...
80106aed:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106af2:	e9 18 f1 ff ff       	jmp    80105c0f <alltraps>
...
80106af9:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106afe:	e9 0c f1 ff ff       	jmp    80105c0f <alltraps>
...
80106b05:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106b0a:	e9 00 f1 ff ff       	jmp    80105c0f <alltraps>
...
80106b11:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106b16:	e9 f4 f0 ff ff       	jmp    80105c0f <alltraps>
...
80106b1d:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106b22:	e9 e8 f0 ff ff       	jmp    80105c0f <alltraps>
...
80106b29:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106b2e:	e9 dc f0 ff ff       	jmp    80105c0f <alltraps>
...
80106b35:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106b3a:	e9 d0 f0 ff ff       	jmp    80105c0f <alltraps>
...
80106b41:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106b46:	e9 c4 f0 ff ff       	jmp    80105c0f <alltraps>
...
80106b4d:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106b52:	e9 b8 f0 ff ff       	jmp    80105c0f <alltraps>
...
80106b59:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106b5e:	e9 ac f0 ff ff       	jmp    80105c0f <alltraps>
...
80106b65:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106b6a:	e9 a0 f0 ff ff       	jmp    80105c0f <alltraps>
...
80106b71:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106b76:	e9 94 f0 ff ff       	jmp    80105c0f <alltraps>
...
80106bda:	e8 71 dd ff ff       	call   80104950 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106d47:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106d4a:	e8 31 cc ff ff       	call   80103980 <cpuid>
  pd[0] = size-1;
...
80106dd4:	a1 a4 59 11 80       	mov    0x801159a4,%eax
...
80106e18:	0f 84 c2 00 00 00    	je     80106ee0 <switchuvm+0xf0>
  pushcli();
80106e1e:	e8 1d d9 ff ff       	call   80104740 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106e23:	e8 e8 ca ff ff       	call   80103910 <mycpu>
80106e28:	89 c3                	mov    %eax,%ebx
80106e2a:	e8 e1 ca ff ff       	call   80103910 <mycpu>
80106e2f:	89 c7                	mov    %eax,%edi
80106e31:	e8 da ca ff ff       	call   80103910 <mycpu>
80106e36:	83 c7 08             	add    $0x8,%edi
80106e39:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106e3c:	e8 cf ca ff ff       	call   80103910 <mycpu>
...
80106f33:	e8 18 da ff ff       	call   80104950 <memset>
...
80106f66:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106f67:	e9 84 da ff ff       	jmp    801049f0 <memmove>
    panic("inituvm: more than a page");
80106f6c:	83 ec 0c             	sub    $0xc,%esp
80106f6f:	68 39 7e 10 80       	push   $0x80107e39
...
801070d9:	68 71 7e 10 80       	push   $0x80107e71
...
8010713b:	68 89 7e 10 80       	push   $0x80107e89
...
8010721c:	68 a5 7e 10 80       	push   $0x80107ea5
...
80107254:	e8 f7 d6 ff ff       	call   80104950 <memset>
...
801072bf:	a3 a4 59 11 80       	mov    %eax,0x801159a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801072f3:	68 b6 7e 10 80       	push   $0x80107eb6
...
801073d9:	68 da 7e 10 80       	push   $0x80107eda
801073de:	e8 ad 8f ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
801073e3:	83 ec 0c             	sub    $0xc,%esp
801073e6:	68 c0 7e 10 80       	push   $0x80107ec0
...
8010746e:	e8 7d d5 ff ff       	call   801049f0 <memmove>
    len -= n;
    buf += n;
