...
main(void)
{
  ...
  1d:	e8 89 03 00 00       	call   3ab <open>
  ...
  30:	6a 00                	push   $0x0
  32:	e8 ac 03 00 00       	call   3e3 <dup>
  dup(0);  // stderr
  37:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3e:	e8 a0 03 00 00       	call   3e3 <dup>
  ...
  c0:	e8 de 02 00 00       	call   3a3 <exec>
      printf(1, "init: exec sh failed\n");
  c5:	5a                   	pop    %edx
  c6:	59                   	pop    %ecx
  ...
  e2:	e8 cc 02 00 00       	call   3b3 <mknod>
    open("console", O_RDWR);
  e7:	5b                   	pop    %ebx
  e8:	58                   	pop    %eax
  e9:	6a 02                	push   $0x2
  eb:	68 38 08 00 00       	push   $0x838
  f0:	e8 b6 02 00 00       	call   3ab <open>
 ...
 229:	31 f6                	xor    %esi,%esi
{
 ...
 248:	50                   	push   %eax
 249:	6a 00                	push   $0x0
 24b:	e8 33 01 00 00       	call   383 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2b1:	e8 f5 00 00 00       	call   3ab <open>
  if(fd < 0)
 ...
 2c5:	50                   	push   %eax
 2c6:	e8 f8 00 00 00       	call   3c3 <fstat>
  close(fd);
 2cb:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2ce:	89 c6                	mov    %eax,%esi
  close(fd);
 2d0:	e8 be 00 00 00       	call   393 <close>
  return r;
 ...
 42c:	89 d1                	mov    %edx,%ecx
{
 ...
 49e:	56                   	push   %esi
 49f:	57                   	push   %edi
 4a0:	e8 e6 fe ff ff       	call   38b <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 519:	e8 6d fe ff ff       	call   38b <write>
 ...
 579:	e8 0d fe ff ff       	call   38b <write>
        putc(fd, c);
      } else {
 ...
 58d:	e8 f9 fd ff ff       	call   38b <write>
  for(i = 0; fmt[i]; i++){
 ...
 601:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 604:	e8 82 fd ff ff       	call   38b <write>
        ap++;
 ...
 654:	eb 1a                	jmp    670 <printf+0x1a0>
          s = "(null)";
 656:	bb ba 08 00 00       	mov    $0x8ba,%ebx
        while(*s != 0){
 ...
 67b:	57                   	push   %edi
 67c:	53                   	push   %ebx
 67d:	e8 09 fd ff ff       	call   38b <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 79b:	e8 53 fc ff ff       	call   3f3 <sbrk>
  if(p == (char*)-1)
